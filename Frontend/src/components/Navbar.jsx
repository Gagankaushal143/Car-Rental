...
export const Navbar = () => {
  return (
    <nav className="flex items-center justify-between px-6 h-18 max-w-7xl rounded-3xl mx-auto bg-gray-900 text-white mt-1 sticky">
      <div>
        <Link to="/" className="text-orange-500 font-bold text-2xl">🚗 RentalX</Link>
      </div>
      <div className="space-x-8">
        <NavLink to="/" className={({isActive}) => `transition-colors duration-300 ${isActive ? "text-orange-500" : "text-white hover:text-orange-500"}`}>Home</NavLink>
